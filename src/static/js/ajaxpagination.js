...
//** Updated July 14th 15'- v1.2.3: Fixed HTML entity for forward and back arrows
...
ajaxpageclass.createBook.prototype={
	...
	buildpagination:function(selectedpage){ //build pagination links based on length of this.pageinfo.pages[]
		...
		if (this.pageinfo.pages.length<=1){ //no 0 or just 1 page
			...
			paginateHTML+='<li><a href="#previous" rel="'+(selectedpage-1)+'">&laquo;</a></li>\n' //previous link HTML
			...
			paginateHTML+='<li><a href="#next" rel="'+(selectedpage+1)+'">next &raquo;</a></li>\n' //next link HTML
			paginateHTML+='</ul></div>'
		}// end construction
